    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        <div className="bg-white rounded-2xl p-6 shadow">
          <p className="text-xs text-gray-500 mb-6">Last updated: May 26, 2025</p>
          
          <div className="space-y-6 text-sm text-gray-700 leading-relaxed">
            <p>
              This Privacy Policy describes how Karmaterra (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from www.karmaterra.in (the "Site") or otherwise communicate with us regarding the Site (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.
            </p>
            ...
            <section className="mt-8">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">Changes to This Privacy Policy</h2>
              <p>
            ...
            <section className="mt-8">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">How We Collect and Use Your Personal Information</h2>
              <p className="mb-4">
            ...
            <section className="mt-8">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">What Personal Information We Collect</h2>
              <p className="mb-4">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="font-semibold text-gray-800 mb-2">Information We Collect Directly from You</h3>
                  <p className="mb-2">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800 mb-2">Information We Collect about Your Usage</h3>
                  <p>
                    We may also automatically collect certain information about your interaction with the Services ("Usage Data"). To this, we may use cookies, pixels and similar technologies ("Cookies"). Usage Data may include information about how you access and use our Site and your account, including device information, browser information, information about your network connection, your IP address and other information regarding your interaction with the Services.
                  </p>
                </div>

                <div>
                  <h3 className="font-semibold text-gray-800 mb-2">Information We Obtain from Third Parties</h3>
                  <p className="mb-2">
            ...
            <section className="mt-8">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">How We Use Your Personal Information</h2>
              <div className="space-y-4">
                <div>
                  <h3 className="font-semibold text-gray-800 mb-2">Providing Products and Services.</h3>
                  <p>
                ...
                <div>
                  <h3 className="font-semibold text-gray-800 mb-2">Marketing and Advertising.</h3>
                  <p>
                ...
                <div>
                  <h3 className="font-semibold text-gray-800 mb-2">Communicating with You and Service Improvement.</h3>
                  <p>
            ...
            <section className="mt-8">
              ...
              <p>
                Like many websites, we use Cookies on our Site. For specific information about the Cookies that we use related to powering our store with Shopify, see <a href="https://www.shopify.com/legal/cookies" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">https://www.shopify.com/legal/cookies</a>. We use Cookies to power and improve our Site and our Services (including to remember your actions and preferences), to run analytics and better understand user interaction with the Services (in our legitimate interests to administer, improve and optimize the Services). We may also permit third parties and services providers to use Cookies on our Site to better tailor the services, products and advertising on our Site and other websites.
              </p>
              <p className="mt-2">
            ...
            <section className="mt-8">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">How We Disclose Personal Information</h2>
              <p className="mb-4">
                  ...
                  <table className="min-w-full border-collapse border border-gray-300 text-xs">
                    <thead>
                      <tr className="bg-gray-100">
                        ...
                        <th className="border border-gray-300 px-4 py-2 text-left">Categories of Recipients</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        ...
                        <td className="border border-gray-300 px-4 py-2">Vendors and third parties who perform services on our behalf (such as Internet service providers, payment processors, fulfillment partners, customer support partners and data analytics providers)</td>
                      </tr>
                      <tr>
                        ...
                        <td className="border border-gray-300 px-4 py-2">Business and marketing partners</td>
                      </tr>
                      <tr>
                        <td className="border border-gray-300 px-4 py-2">Internet or other similar network activity, such as Usage Data</td>
                        <td className="border border-gray-300 px-4 py-2">Affiliates</td>
                      </tr>
                      <tr>
            ...
            <section className="mt-8">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">Third Party Websites and Links</h2>
              <p>
            ...
            <section className="mt-8">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">Children's Data</h2>
              <p>
            ...
            <section className="mt-8">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">Security and Retention of Your Information</h2>
              <p>
            ...
            <section className="mt-8">
              ...
              <ul className="space-y-3">
                <li>
                  <span className="font-semibold text-gray-800">Right to Access / Know:</span> You may have a right to request access to personal information that we hold about you, including details relating to the ways in which we use and share your information.
                </li>
                <li>
                  <span className="font-semibold text-gray-800">Right to Delete:</span> You may have a right to request that we delete personal information we maintain about you.
                </li>
                <li>
                  <span className="font-semibold text-gray-800">Right to Correct:</span> You may have a right to request that we correct inaccurate personal information we maintain about you.
                </li>
                <li>
                  <span className="font-semibold text-gray-800">Right of Portability:</span> You may have a right to receive a copy of the personal information we hold about you and to request that we transfer it to a third party, in certain circumstances and with certain exceptions.
                </li>
                <li>
                  <span className="font-semibold text-gray-800">Restriction of Processing:</span> You may have the right to ask us to stop or restrict our processing of personal information.
                </li>
                <li>
                  <span className="font-semibold text-gray-800">Withdrawal of Consent:</span> Where we rely on consent to process your personal information, you may have the right to withdraw this consent.
                </li>
                <li>
                  <span className="font-semibold text-gray-800">Appeal:</span> You may have a right to appeal our decision if we decline to process your request. You can do so by replying directly to our denial.
                </li>
                <li>
                  <span className="font-semibold text-gray-800">Managing Communication Preferences:</span> We may send you promotional emails, and you may opt out of receiving these at any time by using the unsubscribe option displayed in our emails to you. If you opt out, we may still send you non-promotional emails, such as those about your account or orders that you have made.
                </li>
          </ul>
              <p className="mt-4">
            ...
            <section className="mt-8">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">Complaints</h2>
              <p>
            ...
            <section className="mt-8">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">International Users</h2>
              <p>
            ...
            <section className="mt-8 border-t pt-6">
              ...
              <p>
                Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at <a href="mailto:karmaterra3@gmail.com" className="text-blue-600 hover:underline">karmaterra3@gmail.com</a>.
              </p>
        </section>
          </div>
        </div>
